            ...
            <div className="header__cart-container">
                ...
                <div className="header__cart">
                    <div className="header__cart__list-container">
                        <ul className="header__cart__list">{listItem}</ul>
                    </div>
                    <div className="header__cart__subtotal">
                        <hr className="header__cart__subtotal__line"></hr>
                        <p className="header__cart__subtotal__title">
                            Subtotal
                        </p>
                        <p className="header__cart__subtotal__value">
                            R$ {subTotalCalculator().toFixed(2)}
                        </p>
                    </div>
                    <div className="header__cart__finish-btn-container">
                        <button className="header__cart__view-cart">
                            Veja seus Itens
                        </button>
                        <button className="header__cart__view-checkout" onClick={() => {
                        document.querySelector(".root").style.overflow ="visible";
                        props.setHeaderCartShow(false);
                    }}>
